...
{
    [ChallengeAttribute(ChallengeEnums.Sursis)]
    public class SursisHandler : ChallengeHandler
    {
        public SursisHandler(Fight fight, ChallengeEnums chall) : base(fight, chall)
        {
            BoostSolo = 10;
            BoostGroup = 10;
