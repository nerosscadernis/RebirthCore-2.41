...
{
    public class SummonIllu : SummonMonster, IStatsOwner
    {
        #region Constructeur
        public SummonIllu(FightTeam team, Fight fight, int id, Fighter caster, FightDisposition point) : base(null, team, fight, id, caster, point)
        {
        ...
        public override void InflictDirectDamage(Damage damage, bool isDeclanched = false)
        {
            Die(damage.Source);
            base.InflictDirectDamage(damage, isDeclanched);
        }
        public override int InflictDamage(Damage damage, bool isDeclanched = false)
        {
            Die(damage.Source);
            return base.InflictDamage(damage, isDeclanched);
        }
        public override void InflictPushDamage(Fighter source, SpellTemplate spell, int dist, bool isSecond = false)
        {
            Die(source);
            base.InflictPushDamage(source, spell, dist, isSecond);
        }
