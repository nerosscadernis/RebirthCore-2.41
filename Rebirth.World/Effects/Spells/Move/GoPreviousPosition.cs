...
{
    [EffectHandler(EffectsEnum.Effect_PreviousPosition)]
    public class GoPreviousPosition : SpellEffectHandler
    {
        public GoPreviousPosition(EffectDice effect, Fighter caster, SpellTemplate spell, CellMap targetedCell, bool critical) : base(effect, caster, spell, targetedCell, critical)
        {
        }
        ...
        public override bool Apply(object token, bool declanched = false)
        {
            foreach (var item in GetAffectedActors())
            {
                ...
                var cellEnd = item.PreviousPosition;
