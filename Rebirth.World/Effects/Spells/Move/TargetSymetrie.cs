...
{
    [EffectHandler(EffectsEnum.Effect_My_Sysmetrie_bis)]
    public class TargetSymetrie : SpellEffectHandler
    {
        public TargetSymetrie(EffectDice effect, Fighter caster, SpellTemplate spell, CellMap targetedCell, bool critical) : base(effect, caster, spell, targetedCell, critical)
        {
        }
        ...
        public override bool Apply(object token, bool declanched = false)
        {
            foreach (var item in GetAffectedActors())
            {
                ...
                var cellEnd = item.Point.Point.GetCellSymetrie(TargetedPoint);
